...
/* BLOCO: Função mestre que coordena o processo de abertura, validação e         */
/* injeção de dados na nova janela de slide                                      */
...
/* BLOCO: Função responsável por certificar que todos os argumentos              */
/* obrigatórios foram passados para o motor da janela                            */
...
/* BLOCO: Define as dimensões do monitor e configura as propriedades visuais da  */
/* nova janela pop-up do navegador                                               */
...
/* BLOCO: Função que assegura que o arquivo de dados da tradução e do livro      */
/* solicitados existem na configuração ativa                                     */
...
/* BLOCO: Serializa os objetos de dados em formato JSON para que possam ser      */
/* transmitidos para o ambiente da janela                                        */
...
/* BLOCO: Encerra a execução da janela de projeção ativa e limpa as referências  */
/* globais de controle da interface                                              */
...
/* BLOCO: Atribuição das referências globais para permitir o controle do slide   */
