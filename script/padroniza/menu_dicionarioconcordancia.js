...
// Este arquivo é como o "maestro de uma orquestra" do site da Bíblia.
// Imagine que você tem um controle remoto com 3 botões: Concordância, Dicionário e Sobre.
// Este arquivo:
// 1. Controla o que acontece quando você clica em cada botão
// 2. Muda a aparência da tela (cores, layout) dependendo da seção
// 3. Liga e desliga as diferentes partes do site
// 4. Coordena todos os outros arquivos para trabalharem juntos
// É como ter um "diretor de cinema" que coordena todos os atores (outros arquivos)
// para criar uma experiência perfeita para o usuário!

// Esta é a "classe principal" que controla todo o aplicativo.
// É como ter um "gerente geral" que cuida de tudo no site da Bíblia.

class MainApp {
    constructor() {                                                                                                       
    // ↑ Este é o "construtor" - como montar o gerente quando o site carrega
        window.dataManager = new DataManager();                                                                           
        // ↑ Cria o "gerente de dados" - quem cuida de carregar arquivos e informações
        
        window.concordanciaOptimized = new ConcordanciaOptimized();                                                       
        // ↑ Cria o "sistema de concordância" - quem faz as buscas na Bíblia
        
        window.dicionario = new Dicionario();                                                                             
        // ↑ Cria o "sistema de dicionário" - quem explica as palavras bíblicas

        // Estas linhas "montam" o aplicativo quando ele carrega:
        this.currentSection = 'concordancia';                                                                             
        // ↑ Define que a primeira tela será a "Concordância"
        
        this.initializeElements();                                                                                        
        // ↑ Encontra e "conecta" com todos os botões e elementos da tela
        
        this.bindEvents();                                                                                                
        // ↑ Configura o que acontece quando você clica nos botões
        
        this.initializeApp();                                                                                             
        // ↑ Prepara tudo para funcionar
        
        this.setModuleBodyClass(this.currentSection);                                                                     
        // ↑ Aplica o "tema visual" da seção inicial (cores, estilo)
    }
...
/* BLOCO: Função utilitária global para definir a classe de estilo do corpo com base no endereço da página atual        */
